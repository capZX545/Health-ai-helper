...
SYMPTOM_NAMES_FA: dict[str, str] = {
    ...
    "urinary_hesitancy": "باریکی/سختی شروع ادرار", "joint_swelling": "ورم مفصل", "jaundice": "زردی پوست/چشم", "menstrual_irregular": "عدم نظم قاعدگی"
}
...
SYMPTOM_NAMES_EN: dict[str, str] = {
    ...
    "urinary_hesitancy": "weak/hesitant urine stream", "joint_swelling": "joint swelling", "jaundice": "jaundice (yellow skin/eyes)", "menstrual_irregular": "irregular periods"
}
