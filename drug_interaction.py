...
DRUGS: list[dict[str, Any]] = [
    ...
    {"id": "haloperidol", "fa": ["هالوپریدول", "هدول"], "en": ["haloperidol", "haldol"], "cat": "ضد روان‌پریشی"},
    {"id": "buspirone", "fa": ["بوسپیرون", "بوسپار"], "en": ["buspirone", "buspar"], "cat": "ضد اضطراب (غیر‌بنزودیازپین)"},
    {"id": "hydroxyzine2", "fa": ["هیدروکسی‌زین"], "en": ["hydroxyzine"], "cat": "ضدخارش/آرام‌بخش"},
    ...
    {"id": "passionflower", "fa": ["گل ساعتی", "پاسیفلورا"], "en": ["passionflower", "passiflora"], "cat": "گیاه دارویی (آرام‌بخش)"},
    {"id": "milk_thistle", "fa": ["خارمریم", "سیلی‌مارین"], "en": ["milk thistle", "silymarin"], "cat": "گیاه دارویی (کبد)"},
    {"id": "hawthorn", "fa": ["زالزالک", "کرتگوس"], "en": ["hawthorn", "crataegus"], "cat": "گیاه دارویی (قلب)"},
    {"id": "ginkgo2", "fa": ["گینکو بیلوبا (حافظه)"], "en": ["ginkgo biloba memory"], "cat": "گیاه دارویی (مغز)"},
    {"id": "rosemary", "fa": ["رزماری", "اکلیل‌الجبل"], "en": ["rosemary", "rosmarinus"], "cat": "گیاه دارویی ایرانی"},
    {"id": "thyme", "fa": ["آویشن", "تیموس"], "en": ["thyme", "thymus"], "cat": "گیاه دارویی (سرفه/ضدعفونی)"},
    {"id": "mint", "fa": ["نعناع", "نعنا"], "en": ["mint", "mentha"], "cat": "گیاه دارویی (گوارش)"},
    {"id": "aloe", "fa": ["آلوئه‌ورا", "صبر زرد"], "en": ["aloe vera"], "cat": "گیاه دارویی (پوست/گوارش)"},
    {"id": "lavender", "fa": ["اسطوخودوس", "لاوندر"], "en": ["lavender", "lavandula"], "cat": "گیاه دارویی (آرام‌بخش)"},
    {"id": "cumin", "fa": ["زیره سیاه", "زیره"], "en": ["black cumin", "nigella sativa"], "cat": "گیاه دارویی ایرانی"},
...
INTERACTIONS: list[dict[str, Any]] = [
    ...
    {"a": "rivaroxaban", "b": "amiodarone", "sev": "moderate", "fa": "آمیودارون سطح ریواروکسابان را بالا می‌برد؛ خطر خونریزی؛ تنظیم دوز."},
    {"a": "apixaban", "b": "amiodarone", "sev": "moderate", "fa": "خطر خونریزی؛ پایش."},
    {"a": "ivabradine", "b": "diltiazem", "sev": "moderate", "fa": "کاهش شدید ضربان قلب؛ احتیاط."},
    {"a": "ranolazine", "b": "clarithromycin", "sev": "major", "fa": "کلاریترومایسین سطح رانولازین را بالا می‌برد؛ خطر QT طولانی."},
    {"a": "ranolazine", "b": "fluconazole", "sev": "moderate", "fa": "خطر QT طولانی؛ پایش ECG."},
    {"a": "simvastatin", "b": "clarithromycin", "sev": "major", "fa": "خطر شدید آسیب عضلانی (رابدومیولیز)؛ توقف موقت استاتین."},
    {"a": "methyldopa", "b": "iron_supplement", "sev": "minor", "fa": "آهن جذب متیل‌دوپا را کم می‌کند؛ فاصله‌ی زمانی."},
    {"a": "pioglitazone", "b": "insulin", "sev": "moderate", "fa": "خطر احتباس مایعات و نارسایی قلبی؛ ترکیب با احتیاط."},
    {"a": "semaglutide", "b": "insulin", "sev": "moderate", "fa": "خطر افت قند؛ تنظیم دقیق دوز لازم است."},
    {"a": "clozapine", "b": "carbamazepine", "sev": "major", "fa": "کاربامازپین سطح کلوزاپین را پایین می‌آورد؛ کاهش اثر."},
    {"a": "clozapine", "b": "fluconazole", "sev": "major", "fa": "فلوکونازول سطح کلوزاپین را بالا می‌برد؛ خطر سمیت."},
    {"a": "lithium", "b": "venlafaxine", "sev": "moderate", "fa": "خطر سمیت سروتونرژیک؛ پایش."},
    {"a": "valproate", "b": "carbamazepine", "sev": "moderate", "fa": "تداخل در سطح خون هر دو دارو؛ پایش سطح."},
    {"a": "tacrolimus", "b": "fluconazole", "sev": "major", "fa": "فلوکونازول سطح تاکرولیموس را بالا می‌برد؛ خطر نفروتوکسیسیتی."},
    {"a": "cyclosporine", "b": "clarithromycin", "sev": "major", "fa": "کلاریترومایسین سطح سیکلوسپورین را بالا می‌برد؛ خطر نفروتوکسیسیتی."},
    {"a": "valerian", "b": "zolpidem", "sev": "moderate", "fa": "گیاه + خواب‌آور شیمیایی: خواب‌آلودگی شدید و خطرناک."},
    {"a": "valerian", "b": "diazepam", "sev": "moderate", "fa": "برهم‌کنش افزاینده: آرام‌بخشی شدید."},
    {"a": "stjohnswort", "b": "ocp", "sev": "moderate", "fa": "گل راعی اثر قرص ضدبارداری را کم می‌کند؛ روش کمکی."},
    {"a": "stjohnswort", "b": "warfarin", "sev": "major", "fa": "گل راعی اثر وارفارین را کم می‌کند؛ خطر لخته؛ پایش INR."},
    {"a": "stjohnswort", "b": "cyclosporine", "sev": "major", "fa": "گل راعی سطح سیکلوسپورین را خطرناک پایین می‌آورد؛ خطر رد پیوند."},
    {"a": "echinacea", "b": "cyclosporine", "sev": "moderate", "fa": "ایناکاسیا ممکن است سطح سرکوب‌کننده‌ی ایمنی را تغییر دهد."},
    {"a": "ginkgo", "b": "aspirin", "sev": "moderate", "fa": "گینکو + آسپرین خطر خونریزی را زیاد می‌کند."},
    {"a": "milk_thistle", "b": "warfarin", "sev": "minor", "fa": "خارمریم ممکن است اثر وارفارین را کم کند؛ پایش INR."},
    {"a": "cumin", "b": "warfarin", "sev": "minor", "fa": "زیره سیاه ممکن است اثر ضدانعقادی را تقویت کند؛ پایش."},
]
